...
const App = () => {
    ...
    const onThemeChange=(event)=>{
        ...
        themeElement.setAttribute('href',themeElement.getAttribute('href').replace(theme, event.theme))
    ...
    return (
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            {/* ztt  React官方动画过渡库 react-transition-group */}
            <CSSTransition classNames="layout-sidebar" timeout={{ enter: 200, exit: 200 }} in={isSidebarVisible()} unmountOnExit>
                <div ref={sidebar} className={sidebarClassName} onClick={onSidebarClick}>
                    <div className="layout-logo" style={{cursor: 'pointer',verticalAlign:'middle'}} onClick={() => history.push('/')}>
            ...
            <AppConfig onThemeChange={onThemeChange} rippleEffect={ripple} onRippleEffect={onRipple} inputStyle={inputStyle} onInputStyleChange={onInputStyleChange}
